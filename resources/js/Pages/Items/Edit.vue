                ...
                <div class="container px-5 py-24 mx-auto">
                  <div class="lg:w-1/2 md:w-2/3 mx-auto">
                    <div class="flex flex-wrap -m-2">
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          <div class="leading-7 text-sm text-gray-600">販売状況</div>
                          <label for="selling" class="leading-7 text-sm text-gray-600">販売中</label>
                          <input id="selling" type="radio" v-model="form.is_selling" value="1"
                          ...
                          <label for="not_selling" class="ml-8 leading-7 text-sm text-gray-600">停止中</label>
                          <input id="not_selling" type="radio" v-model="form.is_selling" value="0"
                            class="bg-gray-100 bg-opacity-50 rounded-full border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-1 leading-8 transition-colors duration-200 ease-in-out">
                        </div>
                      </div>
                      <div class="p-2 w-full">
