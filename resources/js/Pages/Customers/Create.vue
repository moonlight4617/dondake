                ...
                <div class="container px-5 py-24 mx-auto">
                  <div class="lg:w-1/2 md:w-2/3 mx-auto">
                    <div class="flex flex-wrap -m-2">
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          <div class="leading-7 text-sm text-gray-600">性別</div>
                          <label for="male" class="leading-7 text-sm text-gray-600">男性</label>
                          <input id="male" type="radio" v-model="form.gender" value="0"
                            class="bg-gray-100 bg-opacity-50 rounded-full border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-1 leading-8 transition-colors duration-200 ease-in-out">
                          <label for="female" class="ml-8 leading-7 text-sm text-gray-600">女性</label>
                          <input id="female" type="radio" v-model="form.gender" value="1"
                            class="bg-gray-100 bg-opacity-50 rounded-full border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-1 leading-8 transition-colors duration-200 ease-in-out">
                          <label for="other" class="ml-8 leading-7 text-sm text-gray-600">その他</label>
                          <input id="other" type="radio" v-model="form.gender" value="2"
                            class="bg-gray-100 bg-opacity-50 rounded-full border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-1 leading-8 transition-colors duration-200 ease-in-out">
                        </div>
                    ...
                    <div class="p-2 w-full">
                      <div class="relative">
                        ...
                        <textarea id="memo" name="memo" v-model="form.memo"
                          class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px- resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
